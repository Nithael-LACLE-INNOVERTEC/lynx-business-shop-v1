...
import { FaTachometerAlt, FaChevronDown, FaChevronLeft, FaCog, FaShoppingCart, FaUserLock, FaSignInAlt } from "react-icons/fa";
    ...
    >
      ...
      <nav className="mt-5 px-4">
        <ul className="flex flex-col gap-2">
          ...
          <li>
            <button
              className={`group flex items-center w-full gap-3 p-3 text-white hover:bg-gray-700 rounded-md ${
                isDashboardOpen ? "bg-gray-700" : ""
              }`}
              ...
              <ul className="pl-6">
                <li>
                  <NavLink
                    to="/auth/dashboard"
                    className={({ isActive }) =>
                      `group flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
