              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      placeholder="6 caractères minimum, 1 lettre majuscule"
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Se connecter"
                    className="w-full cursor-pointer rounded-lg border border-[#cf822d] bg-[#eb8e2f] p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
